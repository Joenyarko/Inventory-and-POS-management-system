...
{
    public partial class Caslogin : Form
    {
        ...
        private void Caslogin_Load(object sender, EventArgs e)
        {
        ...
        private void txtcashierUsername_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                string enteredUsername = txtcashierUsername.Text;
                string enteredPassword = txtcashierPassword.Text;

                // Create a SQL command to check if the entered credentials are valid
                SqlCommand cmd = new SqlCommand("SELECT firstname FROM cashier WHERE username=@username AND pass_word=@pass_word", conn);
                ...
                if (result !=null)
                {
                    ...
                    cashierFirstName=result.ToString();
                    Sales sales = new Sales(cashierFirstName);
                    sales.CashierFirstName = cashierFirstName;
                    sales.Show();
        ...
        private void passCheck_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                txtcashierPassword.UseSystemPasswordChar = true;
            }
            else
            {
                txtcashierPassword.UseSystemPasswordChar = false;
            }
        }

        private void txtcashierUsername_Click(object sender, EventArgs e)
        {
